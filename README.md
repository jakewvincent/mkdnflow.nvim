...
| `to_do.status_propagation.up`             | `boolean`                               | `true`                            | Whether a status change should propagate upwards along the to-do item's parental lineage. If `true`, the logic provided in `to_do.statuses[n].propagate.up` will be used to determine the target status of the parent item. Applies recursively.                                                                                                                                                                                                                                                                                                                           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |      |
...
| `to_do.statuses[*].marker`                | `string\|table`                         | --                                | The marker symbol to use for the status. Up to six bytes are permitted, but the marker must only be one character.                                                                                                                                                                                                                                                                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |      |
...
| `mappings.MkdnEnter`                   | `table (array-like)\|boolean` | `{ { 'n', 'v' }, '<CR>' }`      | Triggers a wrapper function which will (a) infer your editor mode, and then if in normal or visual mode, either follow a link, create a new link from the word under the cursor or visual selection, or fold a section (if cursor is on a section heading); if in insert mode, it will create a new list item (if cursor is in a list), go to the next row in a table (if cursor is in a table), or behave normally (if cursor is not in a list or a table) NOTE: There is no insert-mode mapping for this command by default since some may find its effects intrusive. To enable the insert-mode functionality, add to the mappings table: `MkdnEnter = {{'i', 'n', 'v'}, '<CR>}` |      |
| `mappings.MkdnGoBack`                  | `table (array-like)\|boolean` | `{ 'n', '<BS>' }`               | Open the historically last-active buffer in the current window                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |      |
| `mappings.MkdnGoForward`               | `table (array-like)\|boolean` | `{ 'n', '<Del>' }`              | Open the buffer that was historically navigated away from in the current window                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |      |
| `mappings.MkdnMoveSource`              | `table (array-like)\|boolean` | `{ 'n', '<F2>' }`               | Open a dialog where you can provide a new source for a link and the plugin will rename and move the associated file on the backend (and rename the link source)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |      |
| `mappings.MkdnNextLink`                | `table (array-like)\|boolean` | `{ 'n', '<Tab>' }`              | Move cursor to the beginning of the next link (if there is a next link)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |      |
| `mappings.MkdnPrevLink`                | `table (array-like)\|boolean` | `{ 'n', '<S-Tab>' }`            | Move the cursor to the beginning of the previous link (if there is one)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |      |
| `mappings.MkdnFollowLink`              | `table (array-like)\|boolean` | `false`                         | Open the link under the cursor, creating missing directories if desired, or if there is no link under the cursor, make a link from the word under the cursor                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |      |
| `mappings.MkdnDestroyLink`             | `table (array-like)\|boolean` | `{ 'n', '<M-CR>' }`             | Destroy the link under the cursor, replacing it with just the text from [...]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |      |
| `mappings.MkdnTagSpan`                 | `table (array-like)\|boolean` | `{ 'v', '<M-CR>' }`             | Tag a visually-selected span of text with an ID, allowing it to be linked to with an anchor link                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |      |
| `mappings.MkdnYankAnchorLink`          | `table (array-like)\|boolean` | `{ 'n', 'yaa' }`                | Yank a formatted anchor link (if cursor is currently on a line with a heading)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |      |
| `mappings.MkdnYankFileAnchorLink`      | `table (array-like)\|boolean` | `{ 'n', 'yfa' }`                | Yank a formatted anchor link with the filename included before the anchor (if cursor is currently on a line with a heading)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |      |
| `mappings.MkdnNextHeading`             | `table (array-like)\|boolean` | `{ 'n', ']]' }`                 | Move the cursor to the beginning of the next heading (if there is one)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |      |
| `mappings.MkdnPrevHeading`             | `table (array-like)\|boolean` | `{ 'n', '[[' }`                 | Move the cursor to the beginning of the previous heading (if there is one)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |      |
| `mappings.MkdnIncreaseHeading`         | `table (array-like)\|boolean` | `{ 'n', '+' }`                  | Increase heading importance (remove hashes)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |      |
| `mappings.MkdnDecreaseHeading`         | `table (array-like)\|boolean` | `{ 'n', '-' }`                  | Decrease heading importance (add hashes)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |      |
| `mappings.MkdnToggleToDo`              | `table (array-like)\|boolean` | `{ { 'n', 'v' }, '<C-Space>' }` | Toggle to-do list item's completion status or convert a list item into a to-do list item                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |      |
| `mappings.MkdnNewListItem`             | `table (array-like)\|boolean` | `false`                         | Add a new ordered list item, unordered list item, or (uncompleted) to-do list item                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |      |
| `mappings.MkdnNewListItemBelowInsert`  | `table (array-like)\|boolean` | `{ 'n', 'o' }`                  | Add a new ordered list item, unordered list item, or (uncompleted) to-do list item below the current line and begin insert mode. Add a new line and enter insert mode when the cursor is not in a list.                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |      |
| `mappings.MkdnNewListItemAboveInsert`  | `table (array-like)\|boolean` | `{ 'n', 'O' }`                  | Add a new ordered list item, unordered list item, or (uncompleted) to-do list item above the current line and begin insert mode. Add a new line and enter insert mode when the cursor is not in a list.                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |      |
| `mappings.MkdnExtendList`              | `table (array-like)\|boolean` | `false`                         | Like above, but the cursor stays on the current line (new list items of the same typ are added below)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |      |
| `mappings.MkdnUpdateNumbering`         | `table (array-like)\|boolean` | `{ 'n', '<leader>nn' }`         | Update numbering for all siblings of the list item of the current line                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |      |
| `mappings.MkdnTable ncol nrow (noh)`   | `table (array-like)\|boolean` | `false`                         | Make a table of ncol columns and nrow rows. Pass 'noh' as a third argument to exclude table headers.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |      |
| `mappings.MkdnTableNextCell`           | `table (array-like)\|boolean` | `{ 'i', '<Tab>' }`              | Move the cursor to the beginning of the next cell in the table, jumping to the next row if needed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |      |
| `mappings.MkdnTablePrevCell`           | `table (array-like)\|boolean` | `{ 'i', '<S-Tab>' }`            | Move the cursor to the beginning of the previous cell in the table, jumping to the previous row if needed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |      |
| `mappings.MkdnTableNextRow`            | `table (array-like)\|boolean` | `false`                         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |      |
| `mappings.MkdnTablePrevRow`            | `table (array-like)\|boolean` | `{ 'i', '<M-CR>' }`             |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |      |
| `mappings.MkdnTableNewRowBelow`        | `table (array-like)\|boolean` | `{ 'n', '<leader>ir' }`         | Add a new row below the row the cursor is currently in                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |      |
| `mappings.MkdnTableNewRowAbove`        | `table (array-like)\|boolean` | `{ 'n', '<leader>iR' }`         | Add a new row above the row the cursor is currently in                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |      |
| `mappings.MkdnTableNewColAfter`        | `table (array-like)\|boolean` | `{ 'n', '<leader>ic' }`         | Add a new column following the column the cursor is currently in                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |      |
| `mappings.MkdnTableNewColBefore`       | `table (array-like)\|boolean` | `{ 'n', '<leader>iC' }`         | Add a new column before the column the cursor is currently in                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |      |
| `mappings.MkdnFoldSection`             | `table (array-like)\|boolean` | `{ 'n', '<leader>f' }`          | Fold the section the cursor is currently on/in                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |      |
| `mappings.MkdnUnfoldSection`           | `table (array-like)\|boolean` | `{ 'n', '<leader>F' }`          | Unfold the folded section the cursor is currently on                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |      |
| `mappings.MkdnTab`                     | `table (array-like)\|boolean` | `false`                         | Wrapper function which will jump to the next cell in a table (if cursor is in a table) or indent an (empty) list item (if cursor is in a list item)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |      |
| `mappings.MkdnSTab`                    | `table (array-like)\|boolean` | `false`                         | Wrapper function which will jump to the previous cell in a table (if cursor is in a table) or de-indent an (empty) list item (if cursor is in a list item)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |      |
| `mappings.MkdnCreateLink`              | `table (array-like)\|boolean` | `false`                         | Create a link from the word under the cursor (in normal mode) or from the visual selection (in visual mode)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |      |
| `mappings.MkdnCreateLinkFromClipboard` | `table (array-like)\|boolean` | `{ { 'n', 'v' }, '<leader>p' }` | Create a link, using the content from the system clipboard (e.g. a URL) as the source and the word under cursor or visual selection as the link text                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |      |
...
| --           | --        | `:MkdnTableNextRow<CR>`            | Move the cursor to the beginning of the same cell in the next row of the table                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `<M-CR>`     | i         | `:MkdnTablePrevRow<CR>`            | Move the cursor to the beginning of the same cell in the previous row of the table                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
