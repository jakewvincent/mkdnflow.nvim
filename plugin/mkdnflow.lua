...
if vim.fn.exists('g:loaded_mkdnflow') == 0 then
    ...
    vim.api.nvim_exec("command! MkdnImodeMultiFunc lua require('mkdnflow.wrappers').newListItemOrNextTableRow()", true)
    vim.api.nvim_exec("command! MkdnNVmodeMultiFunc lua require('mkdnflow.wrappers').followOrCreateLinksOrToggleFolds()", true)
