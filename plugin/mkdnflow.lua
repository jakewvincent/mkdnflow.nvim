...
if vim.fn.exists('g:loaded_mkdnflow') == 0 then
    ...
    user_command('MkdnCreateLink', function(opts) mkdnflow.links.createLink(false) end, {})
    user_command('MkdnCreateLinkFromClipboard', function(opts) mkdnflow.links.createLink(true) end, {})
